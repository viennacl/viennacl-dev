      ...
      static database_type init_database(){
        ...
        //Evergreen
         ...
         //Southern Islands
            ...
            map[amd_id][CL_DEVICE_TYPE_GPU][VolcanicIslands]["Hawaii"][std::make_pair(MATRIX_PRODUCT_NT_TYPE,4)] = profile_base_ptr(new matrix_product<'N','T'>(2,8,8,16,4,1,6,1,1,16,8));
