...
namespace viennacl{
  ...
  namespace generator{
    ...
    namespace autotune{
      ...
      double benchmark_impl(viennacl::ocl::device const & dev, viennacl::scheduler::statement const & statement, viennacl::generator::profiles::key_type key, ProfileT const & prof){
      ...
      void benchmark(std::map<double, typename ConfigTypeype::profile_type> * timings, scheduler::statement const & op, viennacl::generator::profiles::key_type const & key, tuning_config<ConfigTypeype> & config, std::ofstream * out){
      ...
      void benchmark(std::map<double, ProfT> * timings, scheduler::statement const & op, viennacl::generator::profiles::key_type const & key, std::list<ProfT> const & profiles){
        viennacl::ocl::device const & dev = viennacl::ocl::current_device();
