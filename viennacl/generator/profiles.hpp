  ...
  namespace generator{
    ...
    namespace profiles{
      ...
      static database_type init_database(){
        ...
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,4)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,4)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,4)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,4)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        ...
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,8)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,8)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,8)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        map[unknown_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,8)] = new matrix_product(1,8,32,8,4,4,4,1,0,false);
        ...
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,4)] = new matrix_product(4,16,64,1,4,4,128,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,4)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,4)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,4)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        ...
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,8)] = new matrix_product(2,16,64,1,8,4,64,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,8)] = new matrix_product(1,16,128,2,8,4,16,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,8)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_CPU][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,8)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        ...
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,4)] = new matrix_product(4,16,64,1,4,4,128,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,4)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,4)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,4)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        ...
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,8)] = new matrix_product(2,16,64,1,8,4,64,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,8)] = new matrix_product(1,16,128,2,8,4,16,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,8)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        map[unknown_id][CL_DEVICE_TYPE_ACCELERATOR][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,8)] = new matrix_product(1,16,64,1,16,4,32,0,0,false);
        ...
        map[amd_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_AA_TYPE,4)] = new matrix_product(4,4,64,32,4,4,4,1,0,false);
        map[amd_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_TA_TYPE,4)] = new matrix_product(4,8,128,16,4,4,8,0,0,false);
        map[amd_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_AT_TYPE,4)] = new matrix_product(4,16,32,16,4,8,4,1,0,false);
        map[amd_id][CL_DEVICE_TYPE_GPU][""][std::make_pair(MATRIX_PRODUCT_TT_TYPE,4)] = new matrix_product(4,16,64,1,8,4,8,0,0,false);
        ...
        //Cypress
        map[amd_id][CL_DEVICE_TYPE_GPU]["Cypress"][std::make_pair(MATRIX_PRODUCT_AA_TYPE,4)] = new matrix_product(4,4,64,16,4,4,8,1,0,false);
        map[amd_id][CL_DEVICE_TYPE_GPU]["Cypress"][std::make_pair(MATRIX_PRODUCT_TA_TYPE,4)] = new matrix_product(4,4,32,32,8,4,4,0,0,false);
        map[amd_id][CL_DEVICE_TYPE_GPU]["Cypress"][std::make_pair(MATRIX_PRODUCT_AT_TYPE,4)] = new matrix_product(4,8,32,16,8,4,8,1,0,false);

        map[amd_id][CL_DEVICE_TYPE_GPU]["Cypress"][std::make_pair(MATRIX_PRODUCT_AA_TYPE,8)] = new matrix_product(2,8,32,16,2,2,8,0,0,false);
