...
public:
  /** @brief Constructor allowing to set the number of sweeps and Jacobi iterations.
    ...
    */
  chow_patel_ilu_tag(vcl_size_t num_sweeps = 3, vcl_size_t num_jacobi_iters = 2) : sweeps_(num_sweeps), jacobi_iters_(num_jacobi_iters) {}
