...
void bisectLarge(const viennacl::linalg::detail::InputData<NumericT> &input,
                 ...
                 const NumericT precision)
    {
      ...
      kernel.global_work_size(0, mat_size > 512 ? MAX_THREADS_BLOCK : MAX_THREADS_BLOCK / 2);     // Use only 128 threads for 256 < n <= 512, this
      kernel.local_work_size(0,  mat_size > 512 ? MAX_THREADS_BLOCK : MAX_THREADS_BLOCK / 2);     // is reasoned
...
void bisectLargeOneIntervals(const viennacl::linalg::detail::InputData<NumericT> &input,
                             ...
                             const NumericT precision)
    {
      ...
      kernel.global_work_size(0, num_blocks * (mat_size > 512 ? MAX_THREADS_BLOCK : MAX_THREADS_BLOCK / 2));
      kernel.local_work_size(0, mat_size > 512 ? MAX_THREADS_BLOCK : MAX_THREADS_BLOCK / 2);
...
void bisectLargeMultIntervals(const viennacl::linalg::detail::InputData<NumericT> &input,
                              ...
                              const NumericT precision)
    {
      ...
      kernel.global_work_size(0, num_blocks_mult * (mat_size > 512 ? MAX_THREADS_BLOCK : MAX_THREADS_BLOCK / 2));
      kernel.local_work_size(0,                     mat_size > 512 ? MAX_THREADS_BLOCK : MAX_THREADS_BLOCK / 2);
