...
namespace viennacl
{
  namespace tools
  {
    ...
    */
    ...
    {
      typedef viennacl::matrix_base<NumericT>   ResultType;
    };
    ...
    struct MATRIX_EXTRACTOR_IMPL<viennacl::matrix_base<NumericT, F>, viennacl::matrix_base<NumericT, F> >
    {
      typedef viennacl::matrix_base<NumericT, F>   ResultType;
    };
