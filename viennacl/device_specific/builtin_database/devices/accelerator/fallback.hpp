...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", vector_axpy_template::parameters_type(1,128,128,FETCH_GLOBAL_CONTIGUOUS));
}

inline void add_4B(database_type<reduction_template::parameters_type> & db)
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", reduction_template::parameters_type(1,128,128,FETCH_GLOBAL_CONTIGUOUS));
}

inline void add_4B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", matrix_axpy_template::parameters_type(1,8,8,8,8,FETCH_GLOBAL_CONTIGUOUS));
}

inline void add_4B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", row_wise_reduction_template::parameters_type(1,1,128,128));
}
...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_LOCAL,FETCH_LOCAL,8,8));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", vector_axpy_template::parameters_type(1,128,128,FETCH_GLOBAL_CONTIGUOUS));
}

inline void add_8B(database_type<reduction_template::parameters_type> & db)
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", reduction_template::parameters_type(1,128,128,FETCH_GLOBAL_CONTIGUOUS));
}

inline void add_8B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", matrix_axpy_template::parameters_type(1,8,8,8,8,FETCH_GLOBAL_CONTIGUOUS));
}

inline void add_8B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", row_wise_reduction_template::parameters_type(1,1,128,128));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_ACCELERATOR, unknown, "", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_LOCAL,FETCH_LOCAL,8,8));
}
