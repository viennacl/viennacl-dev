...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_GPU, unknown, "", vector_axpy_template::parameters_type(1,128,128,1));
}

inline void add_4B(database_type<reduction_template::parameters_type> & db)
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_GPU, unknown, "", reduction_template::parameters_type(1,128,128,1));
}

inline void add_4B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_GPU, unknown, "", matrix_axpy_template::parameters_type(1,8,8,8,8,1));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_GPU, unknown, "", vector_axpy_template::parameters_type(1,128,128,1));
}

inline void add_8B(database_type<reduction_template::parameters_type> & db)
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_GPU, unknown, "", reduction_template::parameters_type(1,128,128,1));
}

inline void add_8B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_GPU, unknown, "", matrix_axpy_template::parameters_type(1,8,8,8,8,1));
}
