...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", row_wise_reduction_template::parameters_type(1,1,128,128));
}
...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_LOCAL,FETCH_LOCAL,8,8));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", row_wise_reduction_template::parameters_type(1,1,128,128));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_LOCAL,FETCH_LOCAL,8,8));
}
