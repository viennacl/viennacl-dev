...
namespace viennacl
{
  namespace scheduler
  {
    ...
    void execute_matrix_row_inplace_add_composite(statement const & s)
    {
      throw "TODO";
    }

    /** @brief Deals with A += B  for a matrix B */
    void execute_matrix_row_inplace_add_matrix(statement const & s)
    {
    ...
    void execute_matrix_row_inplace_add(statement const & s)
    {
      typedef typename statement::container_type   StatementContainer;
