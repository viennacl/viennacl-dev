...
namespace viennacl
{
  namespace scheduler
  {
    ...
    inline void execute_matrix_row_inplace_sub_composite(statement const & s)
    {
    ...
    inline void execute_matrix_row_inplace_sub_matrix(statement const & s)
    {
    ...
    inline void execute_matrix_row_inplace_sub(statement const & s)
    {
      typedef statement::container_type   StatementContainer;
