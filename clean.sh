...
rm viennacl/meta/*.*~
rm viennacl/io/*.*~
rm viennacl/generator/*.*~
rm viennacl/generator/make_code/*.*~
rm viennacl/generator/symbolic_types/*.*~
rm viennacl/generator/traits/*.*~
rm viennacl/generator/meta_tools/*.*~
rm viennacl/linalg/*.*~
