...
{
    std::string scalartype_name = viennacl::device_specific::utils::type_to_string<ScalarType>::value();
    ...
    //OpenCL
//    dump_string_to_file("gemm_NN_" + scalartype_name + "_" + device_name + ".cl", viennacl::device_specific::get_opencl_program_string(saa));
//    dump_string_to_file("gemm_TN_" + scalartype_name + "_" + device_name + ".cl", viennacl::device_specific::get_opencl_program_string(sta));
    dump_string_to_file("gemm_NT_" + scalartype_name + "_" + device_name + ".cl", viennacl::device_specific::get_opencl_program_string(sat));
//    dump_string_to_file("gemm_TT_" + scalartype_name + "_" + device_name + ".cl", viennacl::device_specific::get_opencl_program_string(stt));

    //CUDA
//    dump_string_to_file("gemm_NN_" + scalartype_name + "_" + device_name + ".cu", viennacl::device_specific::get_cuda_device_code(saa));
//    dump_string_to_file("gemm_TN_" + scalartype_name + "_" + device_name + ".cu", viennacl::device_specific::get_cuda_program_string(sta));
    dump_string_to_file("gemm_NT_" + scalartype_name + "_" + device_name + ".cu", viennacl::device_specific::get_cuda_device_code(sat));
//    dump_string_to_file("gemm_TT_" + scalartype_name + "_" + device_name + ".cu", viennacl::device_specific::get_cuda_program_string(stt));
}
