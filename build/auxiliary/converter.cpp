...
void createSourceFile(const char * dirname)
{
    ...
    std::ofstream source_file(("/home/rupp/development/ViennaCL/ViennaCL/build/viennacl/linalg/kernels/" + header_name + "_source.h").c_str());
...
void createKernelFile(const char * dirname)
{
    ...
    std::string header_name(dirname);
    std::ofstream kernel_file(("/home/rupp/development/ViennaCL/ViennaCL/build/viennacl/linalg/kernels/" + header_name + "_kernels.h").c_str());
